<template>
  <div class="is-flex is-flex-direction-row">
    <div class="is-hidden-touch is-hidden-tablet-only">
      <div style="text-align: center; background-color: #efefef;" v-html="adsenseSx"></div>
    </div>
    <div class="container is-widescreen">
      ...
      <br />
      <p>
        <strong>Corsiuniversitari.info </strong>è stato realizzato per aiutarti
        a trovare il tuo corso di laurea. In questo sito ci sono i corsi di
    ...
    <div class="is-hidden-touch is-hidden-tablet-only"> <div style="text-align: center; background-color: #efefef;" v-html="adsenseSx"></div></div>
  </div>
</template>
